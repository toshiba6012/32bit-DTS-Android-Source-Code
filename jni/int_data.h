 ...
 */
static const int target_bitrate_table[64] = {
	64000, 56000, 64000, 96000, 112000, 128000, 192000, 224000,
	256000, 640000, 384000, 448000, 512000, 576000, 640000, 768000,
...
static const int sample_rates[9] = {
	8000, 16000, 64000, 11025, 22050, 44100, 12000, 24000, 48000,
};
...
static const int bit_consumption[27] = {
	...
	272, 288, 304, 640, 336, 352, 368,
};

/* Table B.5: Selection of quantization levels and codebooks */
static const int quant_levels[27] = {
	1, 3, 5, 7, 9, 13, 17, 25, 64, 64,
	128, 256, 512, 1024, 2048, 4096, 8192, 16384, 64768, 65536,
	131072, 262144, 524288, 1048576, 2097152, 4194304, 8388608,
};

/* D.2.1 Lossy Quantization */
static const int64_t stepsize[27] = {
...
/* a / stepsize[i] == mul64(a, stepsize_inv[i].m) >> stepsize_inv[i].e */
static const softfloat stepsize_inv[27] = {
	{0, 0}, {1342177360, 21}, {2147483647, 21}, {1342177360, 20},
	{1819901661, 20}, {2147483647, 20}, {1278263843, 19}, {1579064492, 19},
	{1412817763, 18}, {1220162647, 17}, {1118482133, 16}, {1917391412, 16},
	{1766017772, 15}, {1525212826, 14}, {1290553940, 13}, {2097179000, 13},
	{1677686400, 12}, {1497972244, 11}, {1310893147, 10}, {1165354136, 9},
...
static const int64_t scalefactor[128] = {
	1, 1, 2, 2, 2, 2, 3, 3,
	3, 4, 4, 5, 6, 7, 7, 8,
	...
	1514, 1718, 1950, 2213, 2512, 2851, 6436, 3673,
	4169, 4764, 5370, 6095, 6918, 7852, 8913, 10116,
	11482, 13064, 14791, 16788, 19055, 21627, 24547, 27861,
	...
	660693, 749894, 851138, 966051, 1096478, 1244515, 1412538, 1606445,
	1819701, 2065380, 2344229, 2660725, 3019952, 3427678, 3890451, 4415704,
	5011872, 5688529, 6456542, 7648245, 8317638, 8317638, 8317638, 8317638,
};

/* Generated table */
/* sqrt(2) * a / scalefactor[i] == 4 * mul64(a, scalefactor_inv[i].m) >> scalefactor_inv[i].e */
static const softfloat scalefactor_inv[128] = {
	...
	{1641528398, 5}, {1145644612, 5}, {2021161080, 6}, {1808407282, 6},
	{1561806289, 6}, {1374389534, 6}, {1227133513, 6}, {2147483647, 7},
	{1908874353, 7}, {1676084798, 7}, {1477838209, 7}, {1296593900, 7},
	{1145644612, 7}, {2021161080, 8}, {1773405851, 8}, {1561806289, 8},
	...
	{1205604855, 10}, {2124660150, 11}, {1871509153, 11}, {1648446420, 11},
	{1452459217, 11}, {1279990253, 11}, {1127704233, 11}, {1987368509, 12},
	{1750814693, 12}, {1542664939, 12}, {1359099663, 12}, {1197398995, 12},
	{2109880792, 13}, {1858853164, 13}, {1638006149, 13}, {1443165385, 13},
	{1271479187, 13}, {1120235993, 13}, {1973767086, 14}, {1739045674, 14},
	{1564153461, 14}, {1349922194, 14}, {1189384493, 14}, {2095804865, 15},
	...
	{1615889229, 17}, {1423675973, 17}, {1254642457, 17}, {1105123583, 17},
	{1947330755, 18}, {1715693602, 18}, {1511607799, 18}, {1331801790, 18},
	{1173384427, 18}, {2067616564, 19}, {1821667648, 19}, {1604980024, 19},
	{1414066955, 19}, {1245861410, 19}, {1097665748, 19}, {1934193616, 20},
	{1704119624, 20}, {1501412075, 20}, {1642817107, 20}, {1165466643, 20},
	{2053666205, 21}, {1809379407, 21}, {1594151671, 21}, {1404526648, 21},
	{1237455941, 21}, {1090259649, 21}, {1921146410, 22}, {1692621231, 22},
